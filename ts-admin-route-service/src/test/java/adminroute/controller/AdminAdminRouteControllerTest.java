...
public class AdminAdminRouteControllerTest {
    ...
    public void testAddRoute() throws Exception {
        AdminRouteInfo request = new AdminRouteInfo();
        Mockito.when(adminRouteService.createAndModifyRoute(Mockito.any(AdminRouteInfo.class), Mockito.any(HttpHeaders.class))).thenReturn(response);
